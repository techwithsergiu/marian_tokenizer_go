...
/*
#cgo CXXFLAGS: -std=c++17 -I${SRCDIR} -I${SRCDIR}/../deps/marian_tokenizer_core/src -I${SRCDIR}/../deps/marian_tokenizer_core/include -I${SRCDIR}/../deps/sentencepiece/include
#cgo linux,amd64 LDFLAGS: -L${SRCDIR}/../deps/sentencepiece/linux_amd64/lib/static -lsentencepiece -lstdc++
#cgo windows,amd64 CFLAGS:   -DMARIAN_CORE_BUILD
#cgo windows,amd64 CXXFLAGS: -DMARIAN_CORE_BUILD
#cgo windows,amd64 LDFLAGS: -L${SRCDIR}/../deps/sentencepiece/windows_amd64/lib/static -lsentencepiece -static-libstdc++ -static-libgcc -Wl,-Bstatic -lwinpthread -Wl,-Bdynamic
#include <stdlib.h>
